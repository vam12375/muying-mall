...
public class ExcelExportServiceImpl implements ExcelExportService {
    ...
    public void exportLoginRecords(HttpServletResponse response, Integer adminId,
        ...
        // 查询所有符合条件的登录记录
        com.baomidou.mybatisplus.core.metadata.IPage<AdminLoginRecord> page = 
            loginRecordService.getLoginRecordsPage(1, Integer.MAX_VALUE, adminId, startTime, endTime, loginStatus, ipAddress);
    ...
    public void exportOperationLogs(HttpServletResponse response, Integer adminId,
        ...
        // 查询所有符合条件的操作日志
        com.baomidou.mybatisplus.core.metadata.IPage<AdminOperationLog> page = 
            operationLogService.getOperationLogsPage(1, Integer.MAX_VALUE, adminId, startTime, endTime, 
    ...
    @Override
    public void exportLoginRecordsList(HttpServletResponse response, List<AdminLoginRecord> records, String fileName) throws Exception {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            for (AdminLoginRecord record : records) {
                ...
                row.createCell(3).setCellValue(record.getLoginTime() != null ? record.getLoginTime().format(DATE_TIME_FORMATTER) : "");
                row.createCell(4).setCellValue(record.getLogoutTime() != null ? record.getLogoutTime().format(DATE_TIME_FORMATTER) : "");
                ...
                row.createCell(13).setCellValue(record.getCreateTime() != null ? record.getCreateTime().format(DATE_TIME_FORMATTER) : "");
    ...
    @Override
    public void exportOperationLogsList(HttpServletResponse response, List<AdminOperationLog> logs, String fileName) throws Exception {
        setExcelResponseHeaders(response, fileName);
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            for (AdminOperationLog log : logs) {
                ...
                row.createCell(13).setCellValue(log.getExecutionTimeMs() != null ? log.getExecutionTimeMs().toString() : "");
                row.createCell(14).setCellValue(log.getDescription() != null ? log.getDescription() : "");
                row.createCell(15).setCellValue(log.getCreateTime() != null ? log.getCreateTime().format(DATE_TIME_FORMATTER) : "");
